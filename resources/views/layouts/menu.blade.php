  ...
  <div class="row">
      <div class="container">
          <div class="card-box">
              <h4 class="header-title mb-4">Configuraciòn</h4>
              ...
              <div class="row">
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header" style="background: #1a2942;">
                                  <h5 class="modal-title" style="color:#fff;" id="ModalDescargarLabel">Descargar
                                      paquetes</h5>
                  ...
                  <div class="col-xl-3 col-sm-6">
                      <div class="card bg-pink">
                          <a href="#" class="media-body btn {{$consulta->paquetes}}" type="button" data-toggle="modal"
                              data-target="#ModalDescargar">
                              <div class="card-body widget-style-2">
                                  <div class="text-white media">
                                      <div class="media-body align-self-center">
                                          {{-- <h2 class="my-0 text-white"><span data-plugin="counterup">50</span></h2> --}}
                  ...
                  <!-- Modal -->
                  <div class="modal fade" id="ModalDaq" tabindex="-1" aria-labelledby="ModalDaqLabel"
                      aria-hidden="true">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header" style="background: #1a2942;">
                  ...
                  <div class="col-xl-3 col-sm-6">
                      ...
                      <div class="card bg-purple">
                          <a href="#" class="media-body btn {{$consulta->daq}}" type="button" data-toggle="modal"
                              data-target="#ModalDaq">
                              <div class="card-body widget-style-2">
                                  <div class="text-white media">
                                      <div class="media-body align-self-center">
              ...
              <!-- Modal -->
              <div class="modal fade" id="ModalSnort" tabindex="-1" aria-labelledby="ModalSnortLabel"
                  aria-hidden="true">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header" style="background: #1a2942;">
              ...
              <div class="row">
                  <div class="col-xl-3 col-sm-6">
                      <div class="card bg-info">
                          <a href="#" class="media-body btn {{$consulta->snort}}" type="button" data-toggle="modal"
                              data-target="#ModalSnort">
                              <div class="card-body widget-style-2">
                                  <div class="text-white media">
                                      <div class="media-body align-self-center">
                              ...
                              <div class="card-body widget-style-2">
                                  <div class="text-white media">
                                      <div class="media-body align-self-center">
                                          ...
                                          <p class="mb-0">Configuraciòn Red</p>
                                      </div>
