; $Id$
;
; NSIS Installation script for Snort 2.9.17.1 Win64
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win64 installer for Snort 2.9.17.1 (Win64 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_2.9.17.1_Installer.x64.exe"  ; The name of the installer executable
